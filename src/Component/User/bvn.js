    ...
    fetch(getUrl(`users/me`), {
      ...
      .catch((err) => {
        err.text().then((text) => {
          ...
          if (parseError.bvn) {
            setBvnError(parseError.bvn);
          } else if (parseError[0][1]) {
            setBvnError(parseError[0][1]);
          }
        });
      });
  };
  ...
  return (
    <main>
      {acceptedLoan ? (
        ...
        <>
          <div className="grid bank-info bvn">
            ...
            <div className="capital-layout">
              ...
              <div className="capital-details">
                <div className="information-menu">
                  <Link to="#" className="capital-link ">
                    <i className="capital-link-number">1</i> Bank Information
                  </Link>
                  ...
                  <Link
                    to="capital-1.html"
                    className="capital-link current-capital-link"
                  >
                ...
                <form onSubmit={handleSubmit}>
                  <div
                    className="capital-information block"
                    style={{ paddingTop: "10px" }}
                  >
                    <Errormsg errorText={bvnError[0]} />
                    <Input
                      type="number"
                      class="act-num-input"
                      placeholder="BVN"
